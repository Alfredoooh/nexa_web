      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 40 }}>
          <motion.img
            ...
            alt="Nexa"
          />
          <h1 style={{ fontSize: 28, fontWeight: 700, fontFamily: 'Georgia, serif', color: '#000', margin: 0, textAlign: 'center' }}>Criar conta</h1>
          <p style={{ fontSize: 15, color: '#8E8E93', marginTop: 8, textAlign: 'center' }}>Junta-te à Nexa hoje</p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={fieldWrap}>
            <img src="/assets/icons/svg/find.svg" width={18} height={18} alt="" style={{ filter: 'invert(0.5)', flexShrink: 0 }} />
            <input
          ...
          <div style={fieldWrap}>
            ...
            <input
              type={showPw ? 'text' : 'password'} placeholder="Password (mín. 6 caracteres)" value={password}
        ...
        <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: '#8E8E93' }}>
          Já tens conta?{' '}
          <button onClick={onGoLogin} style={{ background: 'none', border: 'none', color: '#3B82F6', fontWeight: 700, cursor: 'pointer', fontSize: 14 }}>
            Entrar
          </button>
        </p>
      </motion.div>
