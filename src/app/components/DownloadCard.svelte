...
<div class="dl-card" class:dl-card-focused={inputFocused}
  style="background:{c.surface};border-color:{c.divider}">
  ...
  <input
    ...
    placeholder="Cole aqui o link do vídeo ou ficheiro..."
