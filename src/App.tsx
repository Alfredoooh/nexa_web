  ...
  return (
    <>
      ...
      <main className="min-h-screen flex flex-col bg-[#F0F0FF]">
        {/* AppBar blur */}
        <div className="fixed top-0 left-0 right-0 z-40 pointer-events-none" style={{ height: 80 }}>
          <div style={{
        ...
        <div className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-4 pt-3 pb-2">
          ...
          >
            <img src="/assets/icons/svg/menu.svg" alt="Menu" width={16} height={16} />
          </button>
          <button className="w-8 h-8 rounded-full bg-white/80 flex items-center justify-center shadow-sm">
            <img src="/assets/icons/svg/new_chat.svg" alt="Novo chat" width={16} height={16} />
          </button>
        </div>
          ...
          <div className="bg-white rounded-3xl shadow-lg px-4 pt-3 pb-3 flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              <button className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">
                <img src="/assets/icons/svg/add.svg" alt="Adicionar" width={16} height={16} />
              </button>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <img src="/assets/icons/svg/preview.svg" alt="Preview" width={16} height={16} />
