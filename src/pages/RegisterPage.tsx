    ...
    <div style={{
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 700, fontFamily: 'Georgia, serif', color: '#000', margin: 0 }}>Criar conta</h1>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <input type="password" placeholder="Password (mín. 6 caracteres)" value={password} onChange={(e) => setPassword(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleSubmit()} style={inputStyle} />
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, fontSize: 14, color: '#8E8E93' }}>
          Já tens conta?{' '}
          <button onClick={onGoLogin} style={{ background: 'none', border: 'none', color: '#3B82F6', fontWeight: 600, cursor: 'pointer', fontSize: 14 }}>
            Entrar
          </button>
        </p>
      </motion.div>
