...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const onResize = () => {
      ...
      // Só considera teclado se diferença for significativa (>100px)
      const kb = diff > 100 ? Math.min(diff * 0.5, 180) : 0;
  ...
  return (
    <main className="min-h-screen flex flex-col bg-[#F0F0FF]">
      ...
      {/* AppBar com progressive blur iOS */}
      <div className="fixed top-0 left-0 right-0 z-50 pointer-events-none">
        {/* Camadas de blur progressivo */}
        <div style={{ height: 90, position: 'relative' }}>
          <div style={{
            position: 'absolute', inset: 0,
            background: 'linear-gradient(to bottom, rgba(240,240,255,1) 0%, rgba(240,240,255,0.95) 40%, rgba(240,240,255,0.6) 70%, rgba(240,240,255,0) 100%)',
      ...
      {/* Botões AppBar — fixos, não deslizáveis */}
      ...
      {/* Input — sobe suavemente com teclado */}
      <motion.div
